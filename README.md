...
```
![mds-plot for validated SNP positions - including all Gorilla spp. and covering all chromosomes](https://github.com/naturalis/apexomes/raw/master/figures/Gorilla_MDS.pdf "mds-plot for validated SNP positions - including all Gorilla spp. and covering all chromosomes")
